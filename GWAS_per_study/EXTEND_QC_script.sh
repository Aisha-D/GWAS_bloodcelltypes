...
plink2 --bfile /mnt/data1/GWAS_bloodcelltypes/EXTEND/EXTEND_Unrelated_EUR_QCd_sex_upd --missing    
...
plink2 --bfile /mnt/data1/GWAS_bloodcelltypes/EXTEND/EXTEND_Unrelated_EUR_QCd_sex_upd --geno 0.1 --mind 0.1 --make-bed --out EXTEND_Unrelated_EUR_QCd_sex_upd_2

wc -l /mnt/data1/GWAS_bloodcelltypes/EXTEND/EXTEND_Unrelated_EUR_QCd_sex_upd.fam
wc -l /mnt/data1/GWAS_bloodcelltypes/EXTEND/EXTEND_Unrelated_EUR_QCd_sex_upd.bim
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_2.fam
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_2.bim
...
awk '{ if ($1 >= 1 && $1 <= 22) print $2 }' EXTEND_Unrelated_EUR_QCd_sex_upd_2.bim > snp_1_22.txt
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_2 --extract snp_1_22.txt --make-bed --out EXTEND_Unrelated_EUR_QCd_sex_upd_3

# Generate a plot of the MAF distribution.
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_3 --freq --out MAF_check
Rscript --vanilla MAF_check.R

# Remove SNPs with a low MAF frequency.
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_3 --maf 0.01 --make-bed --out EXTEND_Unrelated_EUR_QCd_sex_upd_4
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_3.bim
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_4.bim 
...
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_4 --hardy
...
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_4 --hwe 0.0001 --make-bed --out EXTEND_Unrelated_EUR_QCd_sex_upd_4_hwe
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_4_hwe.bim 
...
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_4_hwe --exclude inversion.txt --range --indep-pairwise 50 5 0.2 --out indepSNP
# Note, don't delete the file indepSNP.prune.in, we will use this file in later steps of the tutorial.

plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_4_hwe  --extract indepSNP.prune.in --het --out R_check
...
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_4_hwe --remove het_fail_ind.txt --make-bed --out EXTEND_Unrelated_EUR_QCd_sex_upd_5

wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_4_hwe.fam
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_5.fam
...
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_5 --extract indepSNP.prune.in --genome --min 0.2 --out pihat_min0.2 
...
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_5 --missing

# Delete the individuals IBD greater than 0.2
plink2 --bfile EXTEND_Unrelated_EUR_QCd_sex_upd_5  --remove plink.nosex --make-bed --out EXTEND_Unrelated_EUR_QCd_sex_upd_6

wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_5.fam
wc -l EXTEND_Unrelated_EUR_QCd_sex_upd_6.fam
